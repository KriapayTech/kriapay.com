...
const ConditionsBody = () => {
  return (
    <div className="bg-[#F7F7F7] overflow-hidden mt-[70px] md:mt-0 md:pt-[60px] mb-[70px] md:mb-[150px] lg:mb-0 2xl:mt-0 2xl:pt-[100px] 2xl:mb-0 ">
      <div className="flex flex-col justify-between items-center w-full md:px-[80px] 2xl:px-[100px] gap-[20px]  2xl:gap-[20px] lg:mt-[50px]">
        ...
        <div className="w-full  px-[37px] md:pl-0 lg:px-0 lg:w-full pt-[70px] md:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-0 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px]  ">
          <h3 className="text-left md:w-full  flex lg:w-[95%] 2xl:w-[93%] text-[#072A30] text-[23px] md:!text-[25px] lg:!text-[30px] tracking-[-1.5px] lg:tracking-[-3px] leading-[33px] font-medium   ">
            Last updated June 25, 2024
          </h3>
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px] border-red-500 border-2">
            <h4 className="text-left md:w-[90%] lg:w-[74%]  text-[#072A30] text-[17px] md:!text-[20px] lg:!text-[27px] tracking-[-1px] md:tracking-[-1.5px] leading-[30px] !font-semibold   2xl:w-[72%] pb-[20px]">
              Introduction
            </h4>
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
              ...
              Terms govern your access to and use of Kriapay's mobile
            ...
            <div className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px] flex flex-col gap-[20px] mt-[40px]">
              <h5 className="!font-semibold !text-[18px]">
                Who we are and our company information:{" "}
              </h5>
              <p>
                We are Kria Technologies Limited ("Company," "we," "us," "our"),
                a company registered in Nigeria at 16, Onijanikin Street,
                Alasia, Lagos 102101. Our operations include the mobile
                application Kriapay (the "App"), along with any other associated
                products and services governed by these legal terms (the "Legal
                Terms") (collectively, the "Services").
              </p>
              <p>
                Kriapay represents the future of effortless, cross-border money
                transfers.
              </p>
              <p>
                ...
                , or by mail at 16, Onijanikin Street, Alasia, Lagos 102101,
                Nigeria.
              </p>
              <p>
                These Legal Terms constitute a binding agreement between you
                ("you" or "user"), whether as an individual user or on behalf of
                an entity, and Kria Technologies Limited regarding your use of
                the Services. By accessing or using the Services, you
                acknowledge that you have read, understood, and agreed to comply
                with all provisions outlined in these Legal Terms.
              </p>
              <p>
                <strong>
                  IF YOU DO NOT AGREE TO ANY PART OF THESE LEGAL TERMS, YOU ARE
                  NOT PERMITTED TO USE THE SERVICES AND MUST DISCONTINUE USE
                  IMMEDIATELY.
                </strong>
              </p>
              <p>
                We will notify you in advance of any planned changes to the
                Services you are using. Changes to the Legal Terms will take
                effect upon posting or notification via info@kriapay.com, as
                specified in the email notification. By continuing to use the
                Services after the effective date of any changes, you accept and
                agree to abide by the updated terms.
              </p>
              <p>
                The Services are designed for users aged 18 and above.
                Individuals under the age of 18 are prohibited from using or
        ...
        {/* Our services */}
        <div className="w-full px-[37px] md:px-0 lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] border-red-500 border-2">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            <h4 className="text-left md:w-[90%] lg:w-[74%]   text-[#072A30] text-[17px] md:!text-[20px] lg:!text-[24px] tracking-[-1px] md:tracking-[-1.5px] leading-[30px] !font-semibold   2xl:w-[72%] pb-[10px]">
              1. OUR SERVICES
            </h4>
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px]">
              ...
              contravene law or regulations, or require us to comply with
              registration requirements in that jurisdiction or country.
              Therefore, individuals who opt to access our Services from other
              locations do so of their own volition and are solely responsible
        ...
        <div className="w-full px-[37px] md:px-0 lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
              ...
              video, text, photographs, and graphics within the Services
            ...
            <ul className="list-disc list-inside ml-6 text-sm space-y-4 w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] tracking-[-0.5px] font-medium pb-2">
              <li className="">Access the Services</li>
              <li>
                Download or print a copy of any portion of the Content to which
                you have rightfully gained access, solely for your personal,
            ...
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
              ...
              grant permission for you to post, reproduce, or publicly display
              any portion of our Services or Content, you must appropriately
            ...
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
              ...
              our Legal Terms, leading to the immediate termination of your
            ...
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
              ...
              transfer to us all intellectual property rights associated with
              such Submissions. You acknowledge that we shall own these
              Submissions and are entitled to unrestricted use and dissemination
            ...
            <ul className="list-disc list-inside ml-6 text-sm space-y-4 md:w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] tracking-[-0.5px] font-medium pb-2">
              <li className="">
              ...
              <li>
                To the extent permissible under applicable law, waive any and
                all moral rights to any such Submission;
              </li>
              <li>
                Warrant that any such Submission is original to you or that you
                possess the necessary rights and licenses to submit such
                Submissions, and that you have full authority to grant us the
                aforementioned rights concerning your Submissions; and
              </li>
              <li>
        ...
        <div className="w-full px-[37px] md:px-0 lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <ol className="list-decimal list-inside ml-6 text-sm space-y-4 w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] tracking-[-0.5px] font-medium pb-2">
              <li className="">
              ...
              <li>
                You possess the legal capacity to enter into these Legal Terms
                and agree to abide by them;
              </li>
              <li>
                You are of legal age in your jurisdiction to use the Services;
              </li>
              <li>
                You will not access the Services using automated or non-human
                means, such as bots or scripts;
              </li>
              <li>
                You will not utilize the Services for any unlawful or
                unauthorized purpose; and
              </li>
              <li>
                Your usage of the Services complies with all applicable laws and
                regulations.
              </li>
            </ol>
            <p className="w-[90%] lg:w-[74%] 2xl:w-[72%] text-[18px] lg:text-[19px] font-medium tracking-[-0.5px]">
        ...
        <div className="w-full px-[37px] md:px-[50px] lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            <h4 className="text-left md:w-[90%] lg:w-[74%]  text-[#072A30] text-[17px] md:text-[21px] lg:!text-[24px] tracking-[-1px] md:tracking-[-1.5px] leading-[30px] !font-semibold   2xl:w-[72%] pb-[10px]">
              4. USER REGISTRATION
            </h4>
            <p className="w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px]">
              ...
              under your account. We reserve the right to remove, reclaim, or
              modify any username you select if we determine, at our sole
              discretion, that the username is inappropriate, obscene, or
        ...
        <div className="w-full px-[37px] md:px-[50px] lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <p className="w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px]">
              ...
              written permission. (2) Attempt to deceive, defraud, or mislead us
              or other users, especially in any attempt to obtain sensitive
              account information such as user passwords. (3) Circumvent,
              disable, or interfere with security-related features of the
              Services or features that enforce limitations on the use of the
              Services or their content. (4) Disparage, harm, or tarnish our
              reputation or that of the Services, in our opinion. (5) Use
              information obtained from the Services to harass, abuse, or harm
              others. (6) Abuse our support services or submit false reports of
              abuse or misconduct. (7) Use the Services in violation of
              applicable laws or regulations. (8) Engage in unauthorized framing
              or linking to the Services. (9) Upload or transmit viruses, Trojan
              horses, or other harmful material, or engage in spamming or
              excessive use of capital letters that disrupts others' use of the
              Services. (10) Use automated systems to post comments or messages,
              or use data mining or similar tools. (11) Remove copyright or
              proprietary notices from any content. (12) Attempt to impersonate
              another user or person or use another user's username. (13) Use
              the Services for information collection or transmission mechanisms
              like "gifs," web bugs, cookies, or similar devices. (14) Interfere
              with the Services or associated networks, or harass our employees
              or agents. (15) Attempt to bypass measures designed to restrict
              access to the Services. (16) Copy or modify the Services'
              software, except as permitted by law. (17) Attempt to decipher,
              decompile, disassemble, or reverse engineer any software part of
              the Services. (18) Develop or use automated systems like spiders,
              robots, or scrapers to access the Services. (19) Use a buying
              agent to make purchases on the Services. (20) Unauthorized
              collection of usernames or email addresses for unsolicited emails
              or automated account creation. (21) Use the Services for
              competitive purposes or commercial enterprises without
              authorization. (22) Sell or transfer your user profile.
            </p>
          </div>
        </div>
        ...
        <div className="w-full px-[37px] md:px-[50px] lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <p className="w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px]">
              ...
              materials ("Contributions") through the Services. Contributions
            ...
            <p className="w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px]">
              ...
              <br /> (1) Infringe upon the proprietary rights, including but not
              limited to copyright, patent, trademark, trade secret, or moral
              rights of any third party. (2) You are the rightful creator and
              owner of the Contributions or possess the necessary licenses,
              rights, consents, releases, and permissions to use them and to
              grant us and other users of the Services permission to use your
              Contributions in accordance with these Legal Terms. (3) You have
              obtained written consent, release, and/or permission from every
              identifiable individual depicted in your Contributions to use
              their name or likeness as necessary for inclusion and use of the
              Contributions in accordance with these Legal Terms. (4) Your
              Contributions are accurate, truthful, and not false or misleading.
              ...
              violent, harassing, defamatory, libelous, slanderous, or otherwise
              objectionable, as determined by us. (7) Your Contributions do not
              ridicule, mock, disparage, intimidate, or abuse any person. (8)
              Your Contributions do not harass or threaten any person in a legal
              sense, nor do they promote violence against any specific
              individual or group. (9) Your Contributions do not violate any
              applicable law, regulation, or rule. (10) Your Contributions do
              not violate the privacy or publicity rights of any third party.
              (11) Your Contributions do not violate any laws concerning child
              pornography or any laws intended to protect the health or
              well-being of minors. (12) Your Contributions do not include
              offensive comments related to race, national origin, gender,
              sexual preference, or physical handicap. (13) Your Contributions
        ...
        <div className="w-full px-[37px] md:px-[50px] lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <ol className="list-decimal list-inside ml-6 text-sm space-y-4 w-[74%] 2xl:w-[72%] text-[19px] tracking-[-0.5px] font-medium pb-2">
              <li className="">
        ...
        <div className="w-full px-[37px] md:px-[50px] lg:px-0 lg:w-full pt-[70px] md:pt-[80px] lg:pt-0 2xl:w-full h-fit  items-start lg:items-end flex flex-col gap-[30px] md:gap-[40px] lg:gap-[50px]  2xl:pl-[0px] md:pr-[20px] 2xl:pr-0 pb-[10px] md:pb-[0px] lg:pb-[110px] ">
          <div className="w-full flex flex-col items-center justify-center mt-4 gap-[20px]">
            ...
            <p className="w-[74%] 2xl:w-[72%] text-[19px] font-medium tracking-[-0.5px] pt-[40px]">
