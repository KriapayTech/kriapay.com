...
const Transacting = () => {
  return (
    <div className="w-full flex justify-center mb-[50px] md:mb-0 mt-[50px] md:mt-[100px] lg:mt-[150px]">
      <div className="w-[85%] bg-[#072a30] rounded-[20px] flex flex-col items-center text-center mt-[100px] lg:mb-[70px] md:pb-[20px] lg:pb-[50px] 2xl:pb-[20px] relative overflow-hidden">
