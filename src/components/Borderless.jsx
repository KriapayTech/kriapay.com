      ...
      <div className="bg-[#072a30] rounded-[20px] overflow-hidden w-[85%] mx-auto h-fit md:h-[580px]">
        <div className="flex flex-col md:flex-row gap-[30px] md:gap-4 items-center justify-between lg:justify-center h-full">
          ...
          <div className="overflow-hidden h-[365px] md:h-full w-full md:w-[53%]  2xl:w-[40%] relative 2xl:pl-3">
            <img
              className=" md:w-[80%] 2xl:w-[88%] h-full md:h-[79%] lg:h-[83%] 2xl:h-[85%] object-cover absolute left-[-17px] md:left-[90px] lg:left-[75px] lg:right-0 bottom-[-40px] 2xl:left-[20px]  md:bottom-[-10px] overflow-x-visible "
